...
class SmsTelponActivity : BaseActivity<SmsTelponPresenter, SmsTelponContract.View>(), SmsTelponContract.View {
    val adapter = SmsTelponListAdapter()
    var list2 = arrayListOf<PulsaPpob>()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val CODE_OPEN_EDIT = 102

    override fun createPresenter(): SmsTelponPresenter {
        return SmsTelponPresenter(this, this)
    }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : SmsTelponListAdapter.ItemClickCallback{
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_smstelpon)
            elevation = 0f
        }
