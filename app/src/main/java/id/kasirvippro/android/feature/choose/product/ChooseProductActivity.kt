...
import id.kasirvippro.android.feature.sell.add.AddActivity
import id.kasirvippro.android.rest.entity.RestException
import id.kasirvippro.android.ui.EndlessRecyclerViewScrollListener
import id.kasirvippro.android.ui.ext.toast
import id.kasirvippro.android.utils.AppConstant
import kotlinx.android.synthetic.main.activity_choose_product.rv_list
import kotlinx.android.synthetic.main.activity_choose_product.sw_refresh

class ChooseProductActivity : BaseActivity<ChooseProductPresenter, ChooseProductContract.View>(),
    ChooseProductContract.View, BottomProductDialog.Listener {
    ...
    override fun openAddProduct() {
        val intent = Intent(this, AddActivity::class.java)
        startActivityForResult(intent, CODE_OPEN_ADD_PRODUCT)
    }
