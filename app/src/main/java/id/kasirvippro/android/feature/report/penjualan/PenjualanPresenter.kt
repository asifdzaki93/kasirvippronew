...
class PenjualanPresenter(val context: Context, val view: PenjualanContract.View) : BasePresenter<PenjualanContract.View>(),
    ...
    private var data: ReportPenjualan.Penjualan? = null
    ...
    override fun onSuccessGetReports(data: ReportPenjualan) {
        view.setData(data)
    }

    override fun onSuccessGetReports2(data: ReportPenjualan) {
