...
import id.kasirvippro.android.feature.pulsaPpob.dataProduct.DataProductActivity
...
class ProductPpobActivity : BaseActivity<ProductPpobPresenter, ProductPpobContract.View>(),
    ProductPpobContract.View {

    val adapter = ProductPpobAdapter()
    var list2 = arrayListOf<ProductPpob>()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val CODE_OPEN_EDIT = 102

    override fun createPresenter(): ProductPpobPresenter {
        return ProductPpobPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : ProductPpobAdapter.ItemClickCallback{
