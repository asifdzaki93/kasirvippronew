...
class ChooseProductPurchaseAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindData(data: Product, position: Int) {
            ...
            if(decimal=="No Decimal") {
                priceTv.text = AppConstant.CURRENCY.getCurrencyData() + Helper.convertToCurrency(data.purchase_price!!) + " " + data.unit
            }else{
                priceTv.text = AppConstant.CURRENCY.getCurrencyData() + data.purchase_price!! + " " + data.unit
            }
