...
class TransactionAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val customerTv = view.tv_customer
        ...
        fun bindData(data: Transaction, position: Int, type:Int) {
            ...
            if(HEADER == type){
                ...
                if (data.name_customer == null){
                    customerTv.text = ""
                }else{
                    customerTv.text = data.name_customer
                }
                ...
                when {
                    ...
                    "debt" == data.status -> {
                        statusTv.setTextColor(ContextCompat.getColor(itemView.context,R.color.status_debt_text))
                        statusTv.background =  ContextCompat.getDrawable(itemView.context,R.drawable.circle_status_debt)
                    }
                    else -> {
