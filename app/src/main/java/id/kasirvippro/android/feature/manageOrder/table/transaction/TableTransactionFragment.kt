...
import kotlinx.android.synthetic.main.fragment_table_transaction.view.*
import org.greenrobot.eventbus.EventBus
import org.greenrobot.eventbus.Subscribe

class TableTransactionFragment : BaseFragment<TableTransactionPresenter, TableTransactionContract.View>(),
    TableTransactionContract.View {

    private val ARGUMENT_PARAM = "ARGUMENT_PARAM"

    private lateinit var _view: View

    val adapter = TableTransactionAdapter()


    companion object {

        @JvmStatic
        fun newInstance(data : Table?) =
            TableTransactionFragment().apply {
    ...
    override fun createPresenter(): TableTransactionPresenter {
        return TableTransactionPresenter(
            activity as Context,
            this
        )
    }
    ...
    override fun onCreateLayout(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        return inflater.inflate(R.layout.fragment_table_transaction, container, false)
    }
    ...
    override fun initAction(view: View) {
        ...
        var data:Table? = null
        if (arguments != null) {
            data = arguments?.getSerializable(ARGUMENT_PARAM) as Table
        }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : TableTransactionAdapter.ItemClickCallback{
