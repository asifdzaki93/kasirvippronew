...
import id.kasirvippro.android.utils.print.PrinterUtilSumary
import java.io.IOException

class PrinterSumaryPresenter(val context: Context, val view: PrinterSumaryContract.View) : BasePresenter<PrinterSumaryContract.View>(),
    PrinterSumaryContract.Presenter, PrinterSumaryContract.InteractorOutput {

    private var interactor = PrinterSumaryInteractor(this)
    private var data:ReportPenjualan?=null
    ...
    override fun onViewCreated(intent: Intent) {
        ...
        bluetoothCallback = object : BluetoothCallback{
            ...
            override fun onConnected(socket: BluetoothSocket?, taskType: Int) {
                ...
                PrinterUtilSumary.print(bluetoothSocket, data, null, premium)
            }
        ...
        data = intent.getSerializableExtra(AppConstant.DATA) as ReportPenjualan
