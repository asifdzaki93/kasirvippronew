...
class TransactionReturnPresenter(val context: Context, val view: TransactionReturnContract.View) : BasePresenter<TransactionReturnContract.View>(),
    TransactionReturnContract.Presenter, TransactionReturnContract.InteractorOutput {


    private var interactor = TransactionReturnInteractor(this)
