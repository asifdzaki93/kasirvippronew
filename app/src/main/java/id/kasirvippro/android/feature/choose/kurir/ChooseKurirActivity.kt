...
class ChooseKurirActivity : BaseActivity<ChooseKurirPresenter, ChooseKurirContract.View>(),
    ChooseKurirContract.View {

    val adapter = ChooseKurirAdapter()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener

    override fun createPresenter(): ChooseKurirPresenter {
        return ChooseKurirPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : ChooseKurirAdapter.ItemClickCallback{
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_search_staff)
            elevation = 0f
        }
