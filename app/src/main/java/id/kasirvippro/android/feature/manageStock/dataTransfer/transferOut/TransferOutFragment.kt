...
class TransferOutFragment : BaseFragment<TransferOutPresenter, TransferOutContract.View>(),
    TransferOutContract.View{

    private lateinit var _view: View
    private var listener: Listener? = null
    private val openFilter = 1100

    val adapter = TransferOutAdapter()
    ...
    override fun createPresenter(): TransferOutPresenter {
        return TransferOutPresenter(activity as Context, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : TransferOutAdapter.ItemClickCallback {
