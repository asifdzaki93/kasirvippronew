...
class ListRawMaterialFragment : BaseFragment<ListRawMaterialPresenter, ListRawMaterialContract.View>(),
    ListRawMaterialContract.View {
    private val CODE_OPEN_EDIT = 1002
    private lateinit var _view: View
    val adapter = ListRawMaterialAdapter()
    ...
    override fun createPresenter(): ListRawMaterialPresenter {
        return ListRawMaterialPresenter(activity as Context, this)
    }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : ListRawMaterialAdapter.ItemClickCallback{
            override fun onClick(data: ReportRawMaterial) {
            }
        }
    ...
    override fun setList(list: List<ReportRawMaterial>) {
