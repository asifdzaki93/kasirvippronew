...
class PrinterSumaryActivity : BaseActivity<PrinterSumaryPresenter, PrinterSumaryContract.View>(), PrinterSumaryContract.View {

    lateinit var adapter:PrinterSumaryAdapter
    private val CODE_OPEN_SETTING = 10001

    override fun createPresenter(): PrinterSumaryPresenter {
        return PrinterSumaryPresenter(this, this)
    }
    ...
    private fun renderView(){
        adapter = PrinterSumaryAdapter(this)
