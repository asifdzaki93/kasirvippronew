...
import id.kasirvippro.android.feature.manageOrder.moveTable.edit.EditMoveTableActivity
...
class MoveTableListActivity : BaseActivity<MoveTableListPresenter, MoveTableListContract.View>(),
    MoveTableListContract.View {

    val adapter = MoveTableListAdapter()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val codeOpenEdit = 102

    override fun createPresenter(): MoveTableListPresenter {
        return MoveTableListPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : MoveTableListAdapter.ItemClickCallback{
    ...
    override fun openEditTablePage(data: Table) {
        val intent = Intent(this, EditMoveTableActivity::class.java)
