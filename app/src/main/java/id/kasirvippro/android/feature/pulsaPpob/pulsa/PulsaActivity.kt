...
class PulsaActivity : BaseActivity<PulsaPresenter, PulsaContract.View>(), PulsaContract.View {
    val adapter = PulsaListAdapter()
    var list2 = arrayListOf<PulsaPpob>()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val CODE_OPEN_EDIT = 102

    override fun createPresenter(): PulsaPresenter {
        return PulsaPresenter(this, this)
    }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : PulsaListAdapter.ItemClickCallback{
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_pulsa)
            elevation = 0f
        }
