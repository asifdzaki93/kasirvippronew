package id.kasirvippro.android.feature.printerReturn
...
import id.kasirvippro.android.utils.print.PrinterUtilReturn
    ...
    override fun onViewCreated(intent: Intent) {
        ...
        bluetoothCallback = object : BluetoothCallback{
            ...
            override fun onConnected(socket: BluetoothSocket?, taskType: Int) {
                ...
                PrinterUtilReturn.print(bluetoothSocket, data, null, premium)
            }
