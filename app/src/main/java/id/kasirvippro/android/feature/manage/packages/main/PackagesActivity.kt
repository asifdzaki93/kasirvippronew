...
import kotlinx.android.synthetic.main.activity_packages.btn_bayar
import kotlinx.android.synthetic.main.activity_packages.et_name
import kotlinx.android.synthetic.main.activity_packages.ll_content
import kotlinx.android.synthetic.main.activity_packages.ll_error
import kotlinx.android.synthetic.main.activity_packages.rv_list
import kotlinx.android.synthetic.main.activity_packages.tv_error
import java.text.NumberFormat
import java.util.*
import java.util.regex.PatternSyntaxException


class PackagesActivity : BaseActivity<PackagesPresenter, PackagesContract.View>(),
    PackagesContract.View, CartCountDialog.Listener {
    ...
    override fun createPresenter(): PackagesPresenter {
        return PackagesPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object :PackagesAdapter.ItemClickCallback {
        ...
        btn_bayar.setOnClickListener {
            ...
            if(decimal=="No Decimal") {
                ...
                getPresenter()?.checkTunai(name, price)
            }else{
                val name = et_name.text.toString().trim()
