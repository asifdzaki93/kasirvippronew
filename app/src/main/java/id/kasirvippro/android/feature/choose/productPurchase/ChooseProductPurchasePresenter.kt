...
class ChooseProductPurchasePresenter(val context: Context, val view: ChooseProductPurchaseContract.View) : BasePresenter<ChooseProductPurchaseContract.View>(),
    ChooseProductPurchaseContract.Presenter, ChooseProductPurchaseContract.InteractorOutput {

    private var interactor  = ChooseProductPurchaseInteractor(this)
