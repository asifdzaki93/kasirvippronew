...
class TransferReturnPresenter(val context: Context, val view: TransferReturnContract.View) : BasePresenter<TransferReturnContract.View>(),
    TransferReturnContract.Presenter, TransferReturnContract.InteractorOutput {

    private var interactor = TransferReturnInteractor(this)
