...
import id.kasirvippro.android.feature.transaction.detailReturnTransfer.DetailReturnActivity
...
class TransactionReturnFragment : BaseFragment<TransactionReturnPresenter, TransactionReturnContract.View>(),
    TransactionReturnContract.View {

    private lateinit var _view: View
    val adapter = TransactionReturnAdapter()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            TransactionReturnFragment().apply {
    ...
    override fun createPresenter(): TransactionReturnPresenter {
        return TransactionReturnPresenter(activity as Context, this)
    }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : TransactionReturnAdapter.ItemClickCallback{
        ...
        _view.btn_sort.setOnClickListener {
            listener?.openFilterByStatusDialog("Filter by status",getPresenter()?.getFilters()!!,getPresenter()?.getFilterSelected(),AppConstant.Code.CODE_TRANSACTION_CUSTOMER2)
        }
    ...
    override fun openDetail(id: String, uuid: String?) {
        val intent = Intent(activity, DetailReturnActivity::class.java)
