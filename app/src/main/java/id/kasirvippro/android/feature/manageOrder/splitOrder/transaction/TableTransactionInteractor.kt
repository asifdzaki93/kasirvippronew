...
class TableTransactionInteractor(var output: TableTransactionContract.InteractorOutput?) : TableTransactionContract.Interactor {
    ...
    override fun callGetTransactionsAPI(context: Context, restModel: TransactionRestModel, id:String) {
        ...
        disposable.add(restModel.getTableTransactions(key!!,id).subscribeWith(object : DisposableObserver<List<Transaction>>() {
