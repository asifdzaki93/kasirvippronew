...
import id.kasirvippro.android.utils.print.PrinterUtilDaily
import java.io.IOException

class PrinterDailyPresenter(val context: Context, val view: PrinterDailyContract.View) : BasePresenter<PrinterDailyContract.View>(),
    PrinterDailyContract.Presenter, PrinterDailyContract.InteractorOutput {

    private var interactor = PrinterDailyInteractor(this)
    ...
    override fun onViewCreated(intent: Intent) {
        ...
        bluetoothCallback = object : BluetoothCallback{
            ...
            override fun onConnected(socket: BluetoothSocket?, taskType: Int) {
                ...
                PrinterUtilDaily.print(bluetoothSocket, data, null, premium)
            }
       ...
       data = intent.getSerializableExtra(AppConstant.DATA) as ReportDaily
