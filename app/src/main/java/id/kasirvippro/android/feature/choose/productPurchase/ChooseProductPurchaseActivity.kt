package id.kasirvippro.android.feature.choose.productPurchase
...
class ChooseProductPurchaseActivity : BaseActivity<ChooseProductPurchasePresenter, ChooseProductPurchaseContract.View>(),
    ChooseProductPurchaseContract.View, BottomProductDialog.Listener {

    val adapter = ChooseProductPurchaseAdapter()
    ...
    override fun createPresenter(): ChooseProductPurchasePresenter {
        return ChooseProductPurchasePresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : ChooseProductPurchaseAdapter.ItemClickCallback{
