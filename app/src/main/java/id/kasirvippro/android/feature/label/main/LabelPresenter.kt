...
class LabelPresenter(val context: Context, val view: LabelContract.View) : BasePresenter<LabelContract.View>(),
    LabelContract.Presenter, LabelContract.InteractorOutput {

    private var interactor = LabelInteractor(this)
    ...
    override fun countCart() {
        ...
        if(count > 99){
            ...
            if(decimal=="No Decimal") {
                ...
                view.setCartText(Helper.convertToCurrency(count),AppConstant.CURRENCY.getCurrencyData() + total)
            }
        }
