...
import kotlinx.android.synthetic.main.activity_move_table.et_table
import kotlinx.android.synthetic.main.activity_move_table.btn_delete_table


class EditMoveTableActivity : BaseActivity<EditMoveTablePresenter, EditMoveTableContract.View>(), EditMoveTableContract.View {

    private val codeOpenChooseTable = 1007

    override fun createPresenter(): EditMoveTablePresenter {
        return EditMoveTablePresenter(this, this)
    }
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_manage_changetable)
            elevation = 0f
    ...
    override fun setMoveTableName(data: Table?) {
        et_table.text = ""
