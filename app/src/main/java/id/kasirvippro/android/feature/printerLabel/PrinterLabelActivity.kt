...
class PrinterLabelActivity : BaseActivity<PrinterLabelPresenter, PrinterLabelContract.View>(), PrinterLabelContract.View {

    lateinit var adapter:PrinterLabelAdapter
    private val CODE_OPEN_SETTING = 10001

    override fun createPresenter(): PrinterLabelPresenter {
        return PrinterLabelPresenter(this, this)
    }
    ...
    private fun renderView(){
        adapter = PrinterLabelAdapter(this)
