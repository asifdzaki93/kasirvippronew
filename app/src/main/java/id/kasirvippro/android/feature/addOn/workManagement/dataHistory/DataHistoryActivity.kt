...
class DataHistoryActivity : BaseActivity<DataHistoryPresenter, DataHistoryContract.View>(),
    ...
    var list2 = arrayListOf<DetailJob>()
    ...
    override fun getIdProduct(): String? {
        val phone_number = getIntent().getStringExtra("no_invoice")
        return phone_number
    }

    override fun setProducts(list: List<DetailJob>) {
        hideLoadingDialog()
        sw_refresh.isRefreshing = false
        list2 = list as ArrayList<DetailJob>
