...
class SupplierCreditFragment : BaseFragment<SupplierCreditPresenter, SupplierCreditContract.View>(),
    SupplierCreditContract.View {

    private val ARGUMENT_PARAM = "ARGUMENT_PARAM"

    private lateinit var _view: View
    val adapter = SupplierCreditAdapter()


    companion object {

        @JvmStatic
        fun newInstance(data : Supplier?) =
                SupplierCreditFragment().apply {
    ...
    override fun createPresenter(): SupplierCreditPresenter {
        return SupplierCreditPresenter(activity as Context, this)
    }
    ...
    override fun initAction(view: View) {
        ...
        _view = view
        renderView()
        var data: Supplier? = null
        if (arguments != null) {
            data = arguments?.getSerializable(ARGUMENT_PARAM) as Supplier
        }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : SupplierCreditAdapter.ItemClickCallback{
