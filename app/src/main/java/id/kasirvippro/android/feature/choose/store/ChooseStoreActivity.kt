...
class ChooseStoreActivity : BaseActivity<ChooseStorePresenter, ChooseStoreContract.View>(),
    ChooseStoreContract.View {

    val adapter = ChooseStoreAdapter()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener

    override fun createPresenter(): ChooseStorePresenter {
        return ChooseStorePresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : ChooseStoreAdapter.ItemClickCallback{
    ...
    override fun onSelected(data: Store) {
