...
import id.kasirvippro.android.feature.manageStock.stockHistoryRawMaterial.data.DataHistoryActivity
...
class StockHistoryListActivity : BaseActivity<StockHistoryListPresenter, StockHistoryListContract.View>(),
    StockHistoryListContract.View {
    ...
    override fun createPresenter(): StockHistoryListPresenter {
        return StockHistoryListPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : StockHistoryListAdapter.ItemClickCallback{
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_stock_history_title)
            elevation = 0f
        }
