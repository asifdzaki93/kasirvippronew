...
class SplitListActivity : BaseActivity<SplitListPresenter, SplitListContract.View>(),
    SplitListContract.View {

    val adapter = SplitListAdapter()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val codeOpenEdit = 102

    override fun createPresenter(): SplitListPresenter {
        return SplitListPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : SplitListAdapter.ItemClickCallback{
            override fun onClick(data: Transaction) {
                openEditTablePage(data.no_invoice!!)
            }
    ...
    override fun openEditTablePage(id:String) {
