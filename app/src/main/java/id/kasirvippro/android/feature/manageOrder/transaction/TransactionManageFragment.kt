...
class TransactionManageFragment : BaseFragment<TransactionManagePresenter, TransactionManageContract.View>(),
    TransactionManageContract.View {

    private lateinit var _view: View
    val adapter = TransactionManageAdapter()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
                TransactionManageFragment().apply {
    ...
    override fun createPresenter(): TransactionManagePresenter {
        return TransactionManagePresenter(activity as Context, this)
    }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : TransactionManageAdapter.ItemClickCallback{
