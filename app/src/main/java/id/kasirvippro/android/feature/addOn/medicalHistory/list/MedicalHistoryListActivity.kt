...
import id.kasirvippro.android.feature.addOn.dataMedical.DataHistoryActivity
...
class MedicalHistoryListActivity : BaseActivity<MedicalHistoryListPresenter, MedicalHistoryListContract.View>(),
    MedicalHistoryListContract.View {

    val adapter = MedicalHistoryListAdapter()
    var list2 = arrayListOf<Customer>()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val CODE_OPEN_EDIT = 1002
    private val CODE_OPEN_SCAN = 1003

    override fun createPresenter(): MedicalHistoryListPresenter {
        return MedicalHistoryListPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : MedicalHistoryListAdapter.ItemClickCallback{
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_patient)
            elevation = 0f
        }

    }
    override fun setProducts(list: List<Customer>) {
        hideLoadingDialog()
