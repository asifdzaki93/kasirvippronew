...
class SupplierCreditInteractor(var output: SupplierCreditContract.InteractorOutput?) : SupplierCreditContract.Interactor {
    ...
    override fun callGetTransactionsAPI(context: Context, restModel: TransactionRestModel, id:String) {
        ...
        disposable.add(restModel.getSupplierDebts(key!!,id).subscribeWith(object : DisposableObserver<List<Transaction>>() {
