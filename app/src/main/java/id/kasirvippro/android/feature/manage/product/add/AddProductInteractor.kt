...
class AddProductInteractor(var output: AddProductPresenter) : AddProductContract.Interactor {
    ...
    override fun callAddProductAPI(context: Context, model: ProductRestModel, name:String,unit:String,kode:String,idkategori:String,jual:String,beli:String,stok:String,
                                   minstok:String,img:String?,desk:String,online:String,haveSTok:String,grosir:String,tax:String,alertstock:String) {
        val key = appSession.getToken(context)
        disposable.add(model.add(key!!,name,unit,kode, idkategori, jual, beli, stok, minstok, img, desk, online, haveSTok,grosir,tax,alertstock).subscribeWith(object : DisposableObserver<Message>() {
