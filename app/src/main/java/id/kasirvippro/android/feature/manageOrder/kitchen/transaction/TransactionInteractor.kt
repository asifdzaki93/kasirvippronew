...
class TransactionInteractor(var output: TransactionContract.InteractorOutput?) : TransactionContract.Interactor {
    ...
    override fun callGetHistoryAPI(context: Context, restModel: TransactionRestModel) {
        val key = appSession.getToken(context)
        disposable.add(restModel.getTransactionOrder(key!!).subscribeWith(object : DisposableObserver<List<HistoryTransaction>>() {
