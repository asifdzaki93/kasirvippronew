...
class PenjualanInteractor(var output: PenjualanContract.InteractorOutput?) :
    PenjualanContract.Interactor {
    ...
    override fun callGetReportsAPI(context: Context, restModel: ReportRestModel, awal:String, akhir:String, id:String?) {
        ...
        disposable.add(restModel.penjualan(key!!,awal,akhir,id).subscribeWith(object : DisposableObserver<ReportPenjualan>() {

            override fun onNext(@NonNull response: ReportPenjualan) {
