...
import id.kasirvippro.android.feature.afiliate.subList.NetworkSubListActivity
...
class NetworkListActivity : BaseActivity<NetworkListPresenter, NetworkListContract.View>(),
    NetworkListContract.View {

    val adapter = NetworkListAdapter()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val CODE_OPEN_EDIT = 1002

    override fun createPresenter(): NetworkListPresenter {
        return NetworkListPresenter(this, this)
    }
    ...
    private fun renderView() {
        ...
        adapter.callback = object : NetworkListAdapter.ItemClickCallback{
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        searchView.queryHint = getString(R.string.lbl_search_network)
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            title = getString(R.string.lbl_network_title)
            elevation = 0f
        }
