...
class AddPackagesPresenter(val context: Context, val view: AddPackagesContract.View) : BasePresenter<AddPackagesContract.View>(),
    AddPackagesContract.Presenter, AddPackagesContract.InteractorOutput {

    private var interactor = AddPackagesInteractor(this)
...
//        }
    ...
    override fun checkAdd(id:String, price:String) {
