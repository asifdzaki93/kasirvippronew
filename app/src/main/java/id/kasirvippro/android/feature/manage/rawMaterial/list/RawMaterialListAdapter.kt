...
import kotlinx.android.synthetic.main.item_list_material.view.*

class RawMaterialListAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private val listProduct = mutableListOf<RawMaterial>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context)
                .inflate(R.layout.item_list_material, parent, false))
    }
    ...
    interface ItemClickCallback{
        ...
        fun onDelete(data: RawMaterial,position: Int)
    }
}