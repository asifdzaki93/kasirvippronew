...
class PaketDataActivity : BaseActivity<PaketDataPresenter, PaketDataContract.View>(), PaketDataContract.View {
    val adapter = PaketDataListAdapter()
    var list2 = arrayListOf<PulsaPpob>()
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener
    private val CODE_OPEN_EDIT = 102

    override fun createPresenter(): PaketDataPresenter {
        return PaketDataPresenter(this, this)
    }
    ...
    private fun renderView(){
        ...
        adapter.callback = object : PaketDataListAdapter.ItemClickCallback{
...
supportActionBar?.apply {
    ...
    title = getString(R.string.lbl_paketdata)
    elevation = 0f
}
